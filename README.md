...
- Summary cards: 12-month peak exposure (with a warning when the TT internal threshold is breached), outstanding balance, and remaining facility capacity
